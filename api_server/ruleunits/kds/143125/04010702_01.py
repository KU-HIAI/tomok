...
class KDS143125_04010702_01(RuleUnit):
    ...
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 25 4.1.7.2 (1)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-23'
    title = '공칭지압강도'
    ...
    Python_Class ~~~ C(["KDS 14 31 25 4.1.7.2 (1)"])
		C --> Variable_def

	  Variable_def --> G --> D --Pass--> E --> F
  	G{"<img src='https://latex.codecogs.com/svg.image?d\leq&space;635mm'>---------------"}
  	D["Pass or Fail"]
    ...
    def nominal_bearing_strength(fIFy,fId,fIl) -> RuleUnitResult:
        ...
        Returns:
            fORn (float): 강구조 연결 설계기준(하중저항계수설계법)  4.1.7.2 확장롤러 및 확장록커 (1)의 값
            pass_fail (bool): 강구조 연결 설계기준(하중저항계수설계법)  4.1.7.2 확장롤러 및 확장록커 (1)의 판단 결과
        """
