...
class KDS143125_04011002_01(RuleUnit):
    ...
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 25 4.1.10.2 (1)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-23'
    title = '웨브 국부공칭강도'
    ...
    flowchart TD
	  ...
	  A[Title: 웨브 국부공칭강도]
	  B["KDS 14 31 25 4.1.10.2 (1)"]
	  A ~~~ B
	  end

	  subgraph Variable_def
    VarOut[/출력변수: 웨브 국부공칭강도/]
  	VarIn1[/입력변수: 인장 또는 압축 집중하중의 작용점에서 재단까지의 거리/]
  	VarIn2[/입력변수: 부재깊이/]
    ...
    Python_Class ~~~ C(["KDS 14 31 25 4.1.10.2 (1)"])
		C --> Variable_def
    ...
    @rule_method
    def web_local_nominal_strength(fIdfaccl,fId,fIk,fIN,fIFyw,fItw) -> RuleUnitResult:
        """웨브 국부공칭강도

        Args:
            fIdfaccl (float): 인장 또는 압축 집중하중의 작용점에서 재단까지의 거리
            fId (float): 부재깊이
        ...
        Returns:
            fORn (float): 강구조 연결 설계기준(하중저항계수설계법)  4.1.10.2 웨브 국부항복강도 (1)의 값
        """

        assert isinstance(fIdfaccl, float)
