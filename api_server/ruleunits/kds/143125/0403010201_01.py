...
class KDS143125_0403010201_01(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 25 4.3.1.2.1 (1)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-23'
    ...
    Python_Class ~~~ C(["KDS 14 31 25 4.3.1.2.1 (1)"])
		C --> Variable_def
    ...
    @rule_method
    def Design_strength_for_local_yield_limit_state(fIBp,fID) -> RuleUnitResult:
        """국부항복 한계상태에 관한 설계강도
        ...
        Returns:
            pass_fail (bool): 강구조 연결 설계기준(하중저항계수설계법)  4.3.1.2.1 원형강관 (1)의 판단 결과
        """
