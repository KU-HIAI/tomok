...
class KDS143125_0403030101_07(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 25 4.3.3.1.1 (7)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-25'
    title = '연성'
    ...
    Python_Class ~~~ C(["KDS 14 31 25 4.3.3.1.1 (7)"])
		C --> Variable_def
    ...
    def ductility(fIFy,fIFu)  -> RuleUnitResult:
        ...
        Returns:
            pass_fail (bool): 강구조 연결 설계기준(하중저항계수설계법)  4.3.3.1.1 적용한계 (7)의 판단 결과
        """
