...
class KDS143125_04030202_02(RuleUnit):
    ...
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 25 4.3.2.2 (2)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-25'
    title = '주강관 응력 상관계수'
    ...
    Python_Class ~~~ C(["KDS 14 31 25 4.3.2.2 (2)"])
		C --> Variable_def
    ...
    @rule_method
    def Cast_steel_pipe_stress_correlation_coefficient(fIbeta,fIPu,fIMu,fIAg,fIFc,fIS) -> RuleUnitResult:
        """주강관 응력 상관계수
        ...
        Returns:
            fOQf (float): 강구조 연결 설계기준(하중저항계수설계법)  4.3.2.2 각형강관 (2)의 값 1
            fOU (float): 강구조 연결 설계기준(하중저항계수설계법)  4.3.2.2 각형강관 (2)의 값 2
            pass_fail (bool): 강구조 연결 설계기준(하중저항계수설계법)  4.3.2.2 각형강관 (2)의 판단 결과
        """
