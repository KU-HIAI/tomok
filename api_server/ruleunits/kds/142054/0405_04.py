...
class KDS142054_0405_04(RuleUnit):
    priority = 1
    acc_able = True
    author = '국가건설기준센터'
    ref_code = 'KDS 14 20 54 4.5 (4)'
    ref_date = '2021-02-18'
    doc_date = '2024-02-13'
    ...
    Python_Class ~~~ C(["KDS 14 20 54 4.5 (4)"])
		C --> Variable_def

    D{"<img src='https://latex.codecogs.com/svg.image?\frac{V_{ua}}{\phi&space;V_{n}}>&space;0.2  and \frac{N_{ua}}{\phi&space;N_{n}}>&space;0.2'>------------------------------"};
    E{"<img src='https://latex.codecogs.com/svg.image?\frac{N_{ua}}{\phi&space;N_{n}}&plus;\frac{V_{ua}}{\phi&space;V_{n}}\leq&space;1.2'>"};
    F(["Pass or Fail"])
    ...
    def simultaneous_action_of_tensile_and_shear_forces(fINua,fIphiNn,fIphiVn,fIVua) -> RuleUnitResult:
        ...
        Returns:
            pass_fail (bool): 콘크리트용 앵커 설계기준  4.5 인장력과 전단력의 동시 작용 (4)의 판단 결과
        """
        ...
        if fIVua/fIphiVn > 0.2 and fINua/fIphiNn > 0.2 :
          if fINua/fIphiNn + fIVua/fIphiVn <= 1.2 :
