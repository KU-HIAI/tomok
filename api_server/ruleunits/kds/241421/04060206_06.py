...
class KDS241421_04060206_06(RuleUnit):
    ...
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 24 14 21 4.6.2.6 (6)'
    ref_date = '2021-04-12'
    doc_date = '2024-02-21'
    title = '전단철근의 최대 간격'
    ...
    A ~~~ B
	  ...
	  Python_Class ~~~ C(["KDS 24 14 21 4.6.2.6 (6)"])
		C --> Variable_def
    ...
    @rule_method
    def Maximum_spacing_of_shear_bars(fId,fIalpha) -> RuleUnitResult:
        """전단철근의 최대 간격
        ...
        Returns:
            fOsmax (float): 콘크리트교 설계기준 (한계상태설계법)  4.6.2.6 전단철근 (6)의 값
        """
