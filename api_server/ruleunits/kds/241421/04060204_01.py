...
class KDS241421_04060204_01(RuleUnit):
    ...
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 24 14 21 4.6.2.4 (1)'
    ref_date = '2021-04-12'
    doc_date = '2024-02-21'
    title = '내측 받침부의 철근량'
    ...
    A ~~~ B
	  ...
	  Python_Class ~~~ C(["KDS 24 14 21 4.6.2.4 (1)"])
		C --> Variable_def
    ...
    def Amount_of_reinforcement_placed_within_the_span(fIreipsp,fIrebamo) -> RuleUnitResult:
        ...
        Returns:
            pass_fail (bool): 콘크리트교 설계기준 (한계상태설계법)  4.6.2.4 내측 받침부 하부 철근의 정착 (1)의 판단 결과
        """

        assert isinstance(fIreipsp, float)
        assert isinstance(fIrebamo, float)

        if fIrebamo >= fIreipsp/4:
