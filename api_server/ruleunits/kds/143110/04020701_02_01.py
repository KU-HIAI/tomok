...
class KDS143110_04020701_02_01(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ...
    VarIn5[/입력변수: 자유돌출 세장판요소의 계수/]
	  ...
	  E{"<img src='https://latex.codecogs.com/svg.image?b/t\leq&space;0.64\sqrt{EK_{c}/F_{y}}'>---------------------------------------------"} ;
    ...
    def Reduction_factor_of_slender_free_projection_plate(fIb,fIt,fIFy,fIE,fIh,fItw)-> RuleUnitResult:
        ...
        if fIb/fIt <= 0.64*(fIE*fOkc/fIFy)**0.5:
          fOQs = 1.0
