...
class KDS143110_04020701_04_02(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ...
    VarIn4[/입력변수: 강재의 탄성계수/]
	  ...
	  F["<img src='https://latex.codecogs.com/svg.image?Q_{s}=1.908-1.22\left(\frac{d}{t}\right)\sqrt{\frac{F_{y}}{E}}'>-----------------------"] ;
    ...
    def Reduction_factor_of_slender_free_projection_plate(fId,fIt,fIE,fIFy)-> RuleUnitResult:
        ...
        if fId/fIt > 0.75*(fIE/fIFy)**0.5 and fId/fIt <= 1.03*(fIE/fIFy)**0.5:
