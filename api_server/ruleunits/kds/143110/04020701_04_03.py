...
class KDS143110_04020701_04_03(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ...
    VarIn4[/입력변수: 강재의 탄성계수/]
	  ...
	  E{"<img src='https://latex.codecogs.com/svg.image?d/t>1.03\sqrt{E/F_{y}}'>---------------------------------------------"} ;
	  F["<img src='https://latex.codecogs.com/svg.image?Q_{s}=\frac{0.69E}{F_{y}\left(\frac{d}{t}\right)^{2}'>-----------------------"] ;
