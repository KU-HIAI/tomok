...
class KDS143110_04040101_02(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 10 4.4.1.1 (2)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-13'
    title = '휨과 압축력의 상관관계'
    ...
    flowchart TD
      ...
      VarIn8[/입력변수: 휨에 대한 강도저항계수/] ;
		...
		Python_Class ~~~ C1(["KDS 14 31 10 4.4.1.1 (2)"]) --> Variable_def
    ...
    def Correlation_between_flexural_and_compressive_force(fIPu,fIPr,fIphic,fIMux,fIMuy,fIMrx,fIMry,fIphib) -> RuleUnitResult:
        ...
        Returns:
            pass_fail (bool): 강구조부재설계기준(하중저항계수설계법) 4.4.1.1 압축력과 휨을 받는 1축 및 2축 대칭단면 부재 (2)의 판단 결과 1
            sOnone (string):강구조부재설계기준(하중저항계수설계법) 4.4.1.1 압축력과 휨을 받는 1축 및 2축 대칭단면 부재 (2)의 판단 결과 2
        """
