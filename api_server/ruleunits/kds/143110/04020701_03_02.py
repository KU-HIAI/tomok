...
class KDS143110_04020701_03_02(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ...
    VarIn4[/입력변수: 강재의 탄성계수/]
	  ...
	  F["<img src='https://latex.codecogs.com/svg.image?Q_{s}=1.34-0.76\left(\frac{b}{t}\right)\sqrt{\frac{F_{y}}{E}}'>-----------------------"] ;
    ...
    def Reduction_factor_of_slender_free_projection_plate(fIb,fIt,fIFy,fIE)-> RuleUnitResult:
        ...
        if fIb/fIt > 0.45*(fIE/fIFy)**0.5 and fIb/fIt <= 0.91*(fIE/fIFy)**0.5:
