...
class KDS143110_04020701_01_03(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 10 4.2.7.1 (1) ③'
    ref_date = '2017-12-20'
    doc_date = '2024-02-13'
    ...
    VarIn4[/입력변수: 강재의 항복강도/]
		...
		Python_Class ~~~ C(["KDS 14 31 10 4.2.7.1 (1) ③"])
		C --> Variable_def

		D["<img src='https://latex.codecogs.com/svg.image?Q_{s}'>------"];
    E{"<img src='https://latex.codecogs.com/svg.image?b/t\geq&space;1.03\sqrt{E/F_{y}}'>-----------------------------------------------------------------"} ;
    F["<img src='https://latex.codecogs.com/svg.image?Q_{s}=\frac{0.69E}{F_{y}\left(\frac{b}{t}\right)^{2}'>---------------------------------------------------------------"] ;
