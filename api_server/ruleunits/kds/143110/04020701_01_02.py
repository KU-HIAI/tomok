...
class KDS143110_04020701_01_02(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ...
    F["<img src='https://latex.codecogs.com/svg.image?Q_{s}=1.415-0.74\left(\frac{b}{t}\right)\sqrt{\frac{F_{y}}{E}}'>---------------------------------------------------------------"] ;
    ...
    def Reduction_factor_of_slender_free_projection_plate(fIb,fIt,fIFy,fIE)-> RuleUnitResult:
        ...
        if 0.56*(fIb/fIt) < fIb/fIt < 1.03*(fIE/fIFy)**0.5:
