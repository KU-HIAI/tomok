...
class KDS143110_040501030102_01(RuleUnit):
    ...
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 10 4.5.1.3.1.2 (1)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-13'
    title = '절점구속 가새 소요강도'
    ...
    flowchart TD
      ...
      VarIn3[/입력변수: 플랜지 도심간의 거리/] ;
		...
		Python_Class ~~~ C1(["KDS 14 31 10 4.5.1.3.1.2 (1)"]) --> Variable_def
    ...
    @rule_method
    def required_strength_of_nodal_restraint_bracing(fIMu,fICd,fIho) -> RuleUnitResult:
        """절점구속 가새 소요강도
        ...
        Returns:
            fOPbu (float): 강구조부재설계기준(하중저항계수설계법) 4.5.1.3.1.2 절점구속 가새 (1)의 값
        """
