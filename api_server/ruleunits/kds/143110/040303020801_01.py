...
class KDS143110_040303020801_01(RuleUnit):
    priority = 1
    acc_able = True
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 10 4.3.3.2.8.1 (1)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-13'
    title = '휨강도-부모멘트부 압축플랜지의 종방향 응력'
    ...
    flowchart TD
		...
		A[Title: 휨강도-부모멘트부 압축플랜지의 종방향 응력] ;
		B["KDS 14 31 10 4.3.3.2.8.1 (1)"] ;
		A ~~~ B
		end
    ...
    VarIn3[/입력변수: 압축플랜지의 공칭휨강도/] ;
		...
		Python_Class ~~~ C(["KDS 14 31 10 4.3.3.2.8.1 (1)"])
		C --> Variable_def
    ...
    @rule_method
    def longitudinal_stress_of_flexural_strength_negative_moment_compression_flange(fIfbu,fIphif,fIFnc) -> RuleUnitResult:
        """휨강도-부모멘트부 압축플랜지의 종방향 응력
        ...
        Returns:
            pass_fail (bool): 강구조부재설계기준(하중저항계수설계법)  4.3.3.2.8.1 일반사항 (1)의 판단 결과
        """
