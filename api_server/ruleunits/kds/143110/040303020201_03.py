...
class KDS143110_040303020201_03(RuleUnit):
    ...
    acc_able = True
    author = '국가건설기준센터'
    ref_code = 'KDS 14 31 10 4.3.3.2.2.1 (3)'
    ref_date = '2017-12-20'
    doc_date = '2024-02-13'
    title = '수평보강재가 있는 웨브의 단면비'
    ...
    VarIn2[/입력변수: 웨브 두께/] ;
		...
		Python_Class ~~~ C(["KDS 14 31 10 4.3.3.2.2.1 (3)"])
		C --> Variable_def

		D{"<img src=https://latex.codecogs.com/svg.image?\frac{D}{t_{w}}\leq&space;300>------------------------"}
    ...
    def Section_ratio_of_web_without_horizontal_stiffener(fID,fItw) -> RuleUnitResult:
        ...
        Returns:
            pass_fail (bool): 강구조부재설계기준(하중저항계수설계법)  4.3.3.2.2.1 웨브 단면비 (3)의 판단 결과
        """
