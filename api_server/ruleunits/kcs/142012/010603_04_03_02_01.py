...
class KCS142012_010603_04_03_02_01(RuleUnit):
    priority = 1
    acc_able = True
    author = '국가건설기준센터'
    ...
    G --> |"True"|H["<img src='https://latex.codecogs.com/png.image?\dpi{500} p= C_{w}C_{c}[7.2 + \frac{790R}{T+18}]'>----------------------------------------"];
    H --> J["min(max(p, 30*Cw), WH) \n ."]
    J --> End([벽체의 측압])
    """
