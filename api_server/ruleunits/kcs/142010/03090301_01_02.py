...
class KCS142010_03090301_01_02(RuleUnit):
...
flowchart TD
    ...
    @rule_method
    def mixer_blending_capability(fIDifCoa) -> RuleUnitResult:
        """믹서의 혼합성능
        ...
        Returns:
            pass_fail (bool): 일반콘크리트 3.9.3.1 믹서 (1) ②의 콘크리트 중 단위굵은골재량 차이의 판단 결과

                    """
        assert isinstance(fIDifCoa, float)
        if fIDifCoa <= 5:
            pass_fail = True
