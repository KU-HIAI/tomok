...
class KCS244020_030603_04(RuleUnit):
    priority = 1
    acc_able = False
    author = '국가건설기준센터'
    ref_code = 'KCS 24 40 20 3.6.3 (4)'
    ref_date = '2016-06-30'
    doc_date = '2023-10-17'
    title = '고무아스팔트계 도포 시 기포 제거'
    ...
    VarOut[/출력변수: 고무아스팔트계 도포 시 기포 제거/];
    VarIn1[/입력변수: 기포 직경/];
    VarOut ~~~ VarIn1
    end
    ...
    def bubble_spreading(fIBubDia) -> RuleUnitResult:
        ...
        Returns:
            sOBubSpr (str): 고무아스팔트계 도포 시 기포 제거
        """
