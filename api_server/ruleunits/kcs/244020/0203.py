...
class KCS244020_0203(RuleUnit):
    ...
    def quality_paintable_waterproof(sIIte,bITesMet,bIStaVal) -> RuleUnitResult:
        """
        Args:
            sIIte (str): 항목
            bITesMet (bool): 시험방법
        ...
        if bITesMet:
            ...
            if sIIte == "작업성":
                ...
                sOQuaMat = "1.5 N/㎟ 이상"
            elif sIIte == "알칼리 처리 인장강도" or  sIIte == "가열 처리 인장강도":
                sOQuaMat = "무처리의 80% 이상"
            elif sIIte == "무 처리 신장률":
                sOQuaMat = "100 % 이상"
            elif sIIte == "알칼리 처리 신장률" or  sIIte == "가열 처리 신장률":
                sOQuaMat = "무처리의 80% 이상"
