...
class KCS143125_030105_03_03(RuleUnit):
...
flowchart TD
    ...
    @rule_method
    def primary_tightening_torque_values_of_bolts(sIQuaCla, sIHigBol) -> RuleUnitResult:
        """볼트에 따른 1차조임 토크값

        Args:
            sIQuaCla (str): 품질관리 구분
            sIHigBol (str): 고장력볼트의 호칭

        Returns:
            fOTigTor (float): 1차조임 토크
        """
        assert isinstance(sIQuaCla, str)
        assert isinstance(sIHigBol, str)
