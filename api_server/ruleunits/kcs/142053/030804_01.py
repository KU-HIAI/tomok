...
class KCS142053_030804_01(RuleUnit):
    ...
    D  --> End(["덕트, 보호관 및 긴장재 배치"])
    """

    @rule_method

    def duct_conduit_tendon(sIItem, bITesMet, bITesFre, bIJudCri,bIDesDoc, fIDisTen, fIEleSiz) -> RuleUnitResult:
        """
        Args:
            sIItem (str): 항목
        ...
        Returns:
            sOArrDuc (str): 덕트, 보호관 및 긴장재의 배치의 검사
        """
        assert isinstance(sIItem, str)
        assert sIItem in [ "종류", "지름", "수량", "고정 방법", "배치 위치"]
