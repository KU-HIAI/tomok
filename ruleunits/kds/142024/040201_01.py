...
class KDS142024_040201_01 (RuleUnit):
    ...
    ref_code = 'KDS 14 20 24 4.2.1 (1)' # 건설기준문서
    ref_date = '2021-02-18'  # 고시일
    doc_date = '2023-08-09'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '콘크리트 스트럿의 공칭압축강도 산정'    # 건설기준명
    ...
    @rule_method
    def Calculate_the_nominal_compressive_strength_of_a_concrete_strut(fOFns, fIFboths, fIAcmin, fIfce) -> bool:
        """콘크리트 스트럿의 공칭압축강도 산정.

        Args:
            fOFns (float): 콘크리트 스트럿의 공칭압축강도.
            fIFboths (float): 콘크리트 스트럿 양단부 강도.
