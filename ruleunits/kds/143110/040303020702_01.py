...
class KDS143110_040303020702_01 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 10 4.3.3.2.7.2 (1)' # 건설기준문서
    ref_date = '2017-12-20'  # 디지털 건설문서 작성일
    doc_date = '2023-12-12'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '비조밀단면의 압축플랜지의 강도한계상태를 만족하는 종방향 응력'    # 건설기준명
    ...
    flowchart TD
      ...
      VarIn4[/입력변수: 인장플랜지의 공칭휨강도/] ;
			...
			Variable_def --"압축플랜지"--> C --> F(["PASS or Fail"])
			Variable_def --"인장플랜지"--> D --> F(["PASS or Fail"])
    """

    # 작성하는 룰에 맞게 함수 이름과 내용을 수정,
    @rule_method
    def Flange_longitudinal_stress_without_considering_flange_transverse_bending_or_longitudinal_bending(fIfbu,fIphif,fIFnc,fIFnt,fIuserdefined) -> bool:
        """비조밀단면의 압축플랜지의 강도한계상태를 만족하는 종방향 응력
        Args:
        ...
        Returns:
            bool: 강구조부재설계기준(하중저항계수설계법) 4.3.3.2.7.2 비조밀단면 (1)의 통과여부
        """


        # fIuserdefined == 1 : 압축플랜지
        # fIuserdefined == 2 : 인장플랜지
