...
class KDS143110_040501030101_02 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 10 4.5.1.3.1.1(2)' # 건설기준문서
    ref_date = '2017-12-20'  # 디지털 건설문서 작성일
    doc_date = '2023-12-15'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '상대구속 가새 소요강성'    # 건설기준명
    ...
    @rule_method
    def Required_rigidity(fObetabu,fIphi,fIMu,fICd,fILb,flho) -> bool:
        """상대구속 가새 소요강성
        Args:
            fObetabu (float): 소요강성
            fIphi (float): 강도저항계수
        ...
        Returns:
            bool: 강구조부재설계기준(하중저항계수설계법) 4.5.1.3.1.1 상대구속 가새 (2)의 값
        """
