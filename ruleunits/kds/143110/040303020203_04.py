...
class KDS143110_040303020203_04 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 10 4.3.3.2.2.3 (4)' # 건설기준문서
    ref_date = '2017-12-20'  # 디지털 건설문서 작성일
    doc_date = '2023-12-12'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '바닥판의 내민부'    # 건설기준명
    ...
    @rule_method
    def inner_part_of_bottom_plate(fIipbopl,fIa) -> bool:
        """바닥판의 내민부
        Args:
        ...
        Returns:
            bool: 강구조부재설계기준(하중저항계수설계법) 4.3.3.2.2.3 다중 박스단면의 활하중 분배계수 적용 특별제한 (4)의 통과여부
        """
