...
class KDS142054_0405_02 (RuleUnit):
    ...
    ref_code = 'KDS 14 20 54 4.5 (2)' # 건설기준문서
    ...
    @rule_method
    def Coefficient_shear_load_acting_on_a_single_anchor_or_group_of_anchors(fIVua,fIVn,fINn,fINua) -> float:
        ...
        Returns:
            float: 콘크리트용 앵커 설계기준  4.5 인장력과 전단력의 동시 작용 (2)의 통과 여부
