...
class KDS241421_04050301_02 (RuleUnit):
    ...
    ref_code = 'KDS 24 14 21 4.5.3.1 (2)' # 건설기준문서
    ref_date = '2021-04-12'  # 디지털 건설문서 작성일
    doc_date = '2023-11-14'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '프리캐스트 콘크리트에서 철근의 수평 순간격'    # 건설기준명
    ...
    @rule_method
    def Horizontal_moment_spacing_of_rebar_in_precast_concrete(fIhorins,fIrebnod,fImaxsco) -> float:
        ...
        Returns:
            float: 콘크리트교 설계기준 (한계상태설계법) 4.5.3.1 철근의 최소간격 (2)의 값
        """
