...
class KDS241421_04070502_05 (RuleUnit):
    ...
    ref_code = 'KDS 24 14 21 4.7.5.2 (5)' # 건설기준문서
    ref_date = '2021-04-12'  # 디지털 건설문서 작성일
    doc_date = '2023-12-20'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '현장타설 속빈 슬래브교의 교량 받침'    # 건설기준명
    ...
    @rule_method
    def bearing(fIbearig, fItranrs) ->bool:
        """현장타설 속빈 슬래브교의 교량 받침
        Args:
             fIbearig (float): 교량 받침
             fItranrs (float): 상부구조의 횡방향 회전각
        Returns:
            bool: 콘크리트교 설계기준 (한계상태설계법) 4.7.5.2 (5) 설계기준에 따른 현장타설 속빈 슬래브교의 교량 받침 적합여부
        """
