...
class KDS241421_030303_03 (RuleUnit):
    ...
    ref_code = 'KDS 24 14 21 3.3.3 (3)' # 건설기준문서
    ref_date = '2021-04-12'  # 디지털 건설문서 작성일
    doc_date = '2023-12-01'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '프리스트레싱 강재의 설계 가정에서 스트랜드에 대한 탄성계수의 설계값'    # 건설기준명
    ...
    def Design_value_of_elastic_modulus(fOEp) -> float:
        """프리스트레싱 강재의 설계 가정에서 스트랜드에 대한 탄성계수의 설계값
        ...
        Returns:
            float: 콘크리트교 설계기준 (한계상태설계법) 3.3.3 설계 가정 (3)의 값
        """
