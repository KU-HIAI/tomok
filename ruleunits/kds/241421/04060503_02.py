...
class KDS241421_04060503_02 (RuleUnit):
    ...
    @rule_method
    def Thrust_reinforcement_at_the_center_of_the_floor_section(fIL,fIamorei,fIamrbts,fIuserdefined) ->bool:
        """바닥판 지간 중앙부의 배력철근
        Args:
             fIL (float): 바닥판의 지간
        ...
        Returns:
            bool: 콘크리트교 설계기준 (한계상태설계법) 4.6.5.3 바닥판 하부와 지간 중앙부의 배력철근 (2)의 통과 여부
        """
