...
class KDS241421_04050404_03 (RuleUnit):
    ...
    ref_code = 'KDS 24 14 21 4.5.4.4 (3)' # 건설기준문서
    ...
    A ~~~ B
		...
		C["<img src='https://latex.codecogs.com/svg.image?l_b=(d_b/4)(\sigma&space;_{sd}/f_{bd})'>---------------------------------"]
		C~~~|KDS 24 14 21 4.5.4.3|C
		C--->F
    ...
    @rule_method
    def development_legnth(fOlb,fIdb,fIsigmasd,fIfbd) -> float:
        """정착길이
        ...
        Returns:
            float: 콘크리트교 설계기준 (한계상태설계법) 4.5.4.4 기본정착길이 (3)의 값
        """
