...
class KDS249011_04020313_01 (RuleUnit):
    ...
    ref_code = 'KDS 24 90 11 4.2.3.13 (1)' # 건설기준문서
    ref_date = '2021-04-12'  # 디지털 건설문서 작성일
    doc_date = '2023-10-10'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '접촉면에서의 압력'    # 건설기준명
    ...
    @rule_method
    def Mean_Pressure(fImeapre, fIstrsup) -> bool:
        """접촉면에서의 압력
        ...
        Returns:
            bool: 교량 기타시설설계기준 (한계상태설계법)  4.2.3.13 구조물에 가해지는 힘, 모멘트, 변형 (1)의 통과 여부
        """
