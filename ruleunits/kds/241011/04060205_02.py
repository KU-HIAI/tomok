...
class KDS241011_04060205_02 (RuleUnit):
    ...
    ref_code = 'KDS 24 10 11 4.6.2.5 (2)' # 건설기준문서
    ref_date = '2021-04-15'  # 디지털 건설문서 작성일  (고시일)
    doc_date = '2023-10-06'  # 건설기준문서 -> 디지털 건설기준 변환 기준일 (작성 년월)
    title = '주철근이 차량진행방향에 평행한 경우 캔틸레버 바닥판의 휨모멘트'   # 건설기준명
   ...
   # 이미지 링크 변환 사이트 https://www.somanet.xyz/2017/06/blog-post_21.html
    ...
    flowchart TD
     ...
     A[캔틸레버 바닥판에 작용하는 트럭 윤하중으로 발생되는 휨모멘트];
    ...
    @rule_method
    def bending_moment2(fIX,fIP,fOM) -> str:
        """주철근이 차량진행방향에 평행한 경우 캔틸레버 바닥판의 휨모멘트
        Args:
        ...
        Returns:
            float: fOM,주철근이 차량진행방향에 평행한 경우 캔틸레버 바닥판의 휨모멘트
        """
