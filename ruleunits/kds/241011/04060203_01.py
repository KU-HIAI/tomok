...
class KDS241011_04060203_01 (RuleUnit):
   ...
   # 이미지 링크 변환 사이트 https://www.somanet.xyz/2017/06/blog-post_21.html
    ...
    @rule_method
    def distance(fId,fIdspla,fItdeck) -> bool:
        """바닥판의 지간 KDS 24 10 11 4.6.2.3 (1)의 기준을 만족하는지 여부
        ...
        Returns:
            bool: 교량 설계 일반사항(한계상태설계법) 바닥판의 지간 KDS 24 10 11 4.6.2.3 (1)의 기준을 만족하는지 여부
        """
