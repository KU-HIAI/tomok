...
class KDS143125_0403020204_02 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 25 4.3.2.2.4 (2)' # 건설기준문서
    ...
    @rule_method
    def Design_strength_of_steel_pipe(fOphiPn,fIPn,fIFybi,fItbi,fIHbi,fIbeoi,fIbeov) -> bool:
        ...
        Returns:
            bool: 강구조 연결 설계기준(하중저항계수설계법) 4.3.2.2.4 겹침 K형 접합에서 압축력을 받는 지강관 (2)의 값
        """

        fIPn = fIFybi * fItbi * (2 * fIHbi - 4 * fItbi + fIbeoi + fIbeov)
        fOphiPn = fIPn * 0.95
        return fOphiPn
