...
class KDS143125_0403020102_03 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 25 4.3.2.1.2 (3)' # 건설기준문서
    ref_date = '2017-12-20'  # 고시일
    doc_date = '2023-12-05'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = 'X형 이음에서 주강관 소성화의 한계상태'  # 건설기준명
...
G-->E-->L-->M
    ...
    @rule_method
    def Limit_state_of_chord_plastification_in_X_shaped_joints(fOPnsintheta,fIFy,fIt,fIbeta,fIgamma,fIQf) -> float:
        ...
        Returns:
            float: 강구조 연결 설계기준(하중저항계수설계법)  4.3.2.1.2 T, Y, X형 접합의 압축력을 받는 지강관 (3) 의 값
        """

        fOPnsintheta = fIFy * (fIt**2) * (5.7/(1-0.81*fIbeta)) * fIQf
        return fOPnsintheta
