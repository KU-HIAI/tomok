...
class KDS143125_0403020103_02 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 25 4.3.2.1.3 (2)' # 건설기준문서
  ...
  F-->N-->I
    ...
    @rule_method
    def Limit_state_of_shear_yielding_punching(fOPn,fIFy,fIt,fIDb,fItheta) -> float:
        """전단항복(뚫림)의 한계상태
        ...
        Returns:
            float: 강구조 연결 설계기준(하중저항계수설계법)  4.3.2.1.3 K형 접합의 압축력을 받는 지강관 (2)의 값
        """
