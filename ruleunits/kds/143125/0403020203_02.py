...
class KDS143125_0403020203_02 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 25 4.3.2.2.3 (2) ' # 건설기준문서
    ...
    flowchart TD
		...
		VarIn1[/"입력변수: <img src='https://latex.codecogs.com/svg.image?B_{eff}'>-----"/] ;
		end

		Python_Class ~~~ Variable_def

		C["<img src='https://latex.codecogs.com/svg.image?B_{eff}\geq&space;0.35'>---------------------"] ;
    ...
    @rule_method
    def effective_width(fIBeff) -> bool:
        """유효 폭
        Args:
            fIBeff (float): 유효 폭
