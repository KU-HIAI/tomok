...
class KDS143125_04010402_01 (RuleUnit):
    ...
    title = '접합부재의 전단항복에 대하여 설계전단강도'    # 건설기준명
    ...
    @rule_method
    def Design_shear_strength_for_the_shear_yield_of_the_joint(fOphiRn,fIphi,fIFy,fIAgv) -> bool:
        ...
        Returns:
            bool: 강구조 연결 설계기준(하중저항계수설계법)  4.1.4.2 접합부재의 전단항복에 대한 설계전단강도 (1)의 값
        """
        fOphiRn = fIphi*0.60*fIFy*fIAgv
        return fOphiRn
