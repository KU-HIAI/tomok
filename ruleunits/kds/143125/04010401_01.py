...
class KDS143125_04010401_01 (RuleUnit):
    ...
    title = '접합부재의 인장항복에 대하여 설계인장강도'    # 건설기준명
    ...
    @rule_method
    def Design_tensile_strength_for_the_tensile_yield_of_the_joint(fOphiRn,fIphi,fIFy,fIAg) -> bool:
        ...
        Returns:
            bool: 강구조 연결 설계기준(하중저항계수설계법)  4.1.4.1 접합부재의 인장항복에 대한 설계인장강도 (1)의 값
        """
        fOphiRn = fIphi*fIFy*fIAg
        return fOphiRn
