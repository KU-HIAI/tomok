...
class KDS143125_0403020201_11 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 25 4.3.2.2.1 (11)' # 건설기준문서
    ref_date = '2017-12-20'  # 고시일
    doc_date = '2023-12-05'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '주강관의 항복강도'    # 건설기준명
    ...
    @rule_method
    def yield_strength_of_chord(fIFy) -> bool:
        """주강관의 항복강도
        Args:
            fIFy (float): 주강관의 항복강도

        Returns:
            bool: 강구조 연결 설계기준(하중저항계수설계법) 4.3.2.2.1 적용한계 (11)의 통과여부
        """
