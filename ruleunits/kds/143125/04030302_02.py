...
class KDS143125_04030302_02 (RuleUnit):
    ...
    ref_code = 'KDS 14 31 25 4.3.3.2 (2)' # 건설기준문서
    ...
    @rule_method
    def stress_correlation_coefficient(fOQf,fIU,fIPu,fIMu,fIAg,fIFc,fIS,fIFy,fIbeta) -> float:
        """응력상관계수
        ...
        Args:
            ...
            fIbeta (float): beta
        Returns:
            float: 강구조 연결 설계기준(하중저항계수설계법)  4.3.3.2 각형강관 (2) 의 값
        """
