...
class KDS241221_04090201_02 (RuleUnit):
    ...
    ref_code = 'KDS 24 12 21 4.9.2.1 (2)' # 건설기준문서
    ...
    @rule_method
    def longitudinal_reaction(fOlonrea,fIPdylon,fIAexflo) -> float:
        """종방향 항력

        Args:
            fOlonrea (float): 종방향 항력
            fIPdylon (float): 종방향 동수압
            fIAexflo (float): 흐름에 노출된 투영면적


        Returns:
            float: 강교 설계기준(한계상태설계법) 4.9.2.1 종방향 (2) 의 값
        """
