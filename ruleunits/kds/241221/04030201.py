...
class KDS241221_04030201 (RuleUnit):
    ...
    ref_code = 'KDS 24 12 21 4.3.2.1' # 건설기준문서
...
Variable_def--->D--->E
    ...
    @rule_method
    def Live_load(fOLlive,fILsttr) -> bool:
        """활하중

        Args:
            fOLlive (float): 활하중
            fILsttr (float): 표준트럭하중

        Returns:
            float: 강교 설계기준(한계상태설계법)  4.3.2.1 크기와 형태의 값
        """
