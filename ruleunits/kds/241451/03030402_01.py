...
class KDS241451_03030402_01 (RuleUnit):
    ...
    ref_code = 'KDS 24 14 51 3.3.4.2 (1)' # 건설기준문서
    ref_date = '2021-04-12'  # 디지털 건설문서 작성일
    doc_date = '2023-12-19'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '점성토의 근입 깊이'    # 건설기준명
   ...
   """
    ...
    A ~~~ B
      ...
      Variable_def
			...
			C["<img src='https://latex.codecogs.com/svg.image?1.4[\frac{E_{p}I_{p}}{E_{s}}]^{0.25}'>---------------------------------"]
    ...
    @rule_method
    def Penetration_depth_of_cohesive_soil(fOpendep,fIEp,fIlp,fIEs) -> float:
        """점성토의 근입 깊이
        Args:
        ...
        Returns:
            float: 교량 하부구조 설계기준 (한계상태설계법) 3.3.4.2 말뚝의 좌굴 (1)의 값
