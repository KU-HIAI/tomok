...
class KDS241451_03030203_01 (RuleUnit):
    ...
    ref_code = 'KDS 24 14 51 3.3.2.3 (1)' # 건설기준문서
    ref_date = '2021-04-12'  # 디지털 건설문서 작성일
    doc_date = '2023-12-01'  # 건설기준문서->디지털 건설기준 변환 기준일
    title = '말뚝기초의 침하'    # 건설기준명
   ...
   """
    ...
    @rule_method
    def the_sinking_of_the_foundation_of_a_stake(fIsinsta,fIallsub) -> bool:
        """말뚝기초의 침하
        Args:
        ...
        Returns:
            bool: 교량 하부구조 설계기준 (한계상태설계법) 3.3.2.3(1) 의 건설기준을 통과하는지 여부
