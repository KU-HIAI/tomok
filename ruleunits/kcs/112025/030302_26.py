...
class KCS112025_030302_26(RuleUnit):
  ...
  flowchart TD
    ...
    VarOut[/"출력변수: 바탕(밑창) 콘크리트의 설계기준 강도"/];
    ...
    @rule_method
    def design_strength_of_foundation_concrete(fIDesCon) ->str :
        """바탕 (밑창) 콘크리트의 설계기준 강도

        Args:
            fIDesCon (float): 바탕 (밑창) 콘크리트 설계기준 강도


        Returns:
            sODesCon (string): 바탕 (밑창) 콘크리트 설계기준 강도
