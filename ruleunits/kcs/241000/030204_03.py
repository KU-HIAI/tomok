...
class KCS241000_030204_03(RuleUnit):

    priority = 1
    author = '서울대학교, 최정운'
    ref_code = 'KCS 24 10 00 3.2.4 (3)'
    ref_date = '2018-08-30'
    doc_date = '2023-09-25'
    title = '그라우트의 시공기간'
    ...
    A[Title: 그라우트의 시공기간];
    B["KCS 24 10 00 3.2.4 (3)"];
    B ~~~ A
    end

    KCS(["KCS 24 10 00 3.2.4 (3)"])
    ...
    @rule_method
    def grouting_interval(fIHum, bICorPro) -> float:
        """
        Args:
            fIHum (float): 습도
