...
class KCS243000_030304_03(RuleUnit):
    ...
    @rule_method
    def roughness_plate(bIRou50,fIMinSli):
        """
        Args:
            bIRou50 (boolean): 50S 정도의 거칠기
            fIMinSli (float): 미끄럼계수
        Returns:
            sORouSur (string): 연결되는 판의 접합면 거칠기
        """
    ...
    def bolt_axial_force(self, sIBolCla,sIBolNam):
        """
        Args:
